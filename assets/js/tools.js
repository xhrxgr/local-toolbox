...
const TOOLS = [
  ...
  },
  {
    ...
    name: '文档转换',
    icon: 'document',
    desc: 'PDF/Word/Excel/CSV/Markdown/HTML/TXT/RTF/EPUB 本地互转，文件不上传云端',
    category: 'document',
    tags: ['本地处理', 'PDF/Word/Excel', 'RTF/EPUB'],
    aliases: ['文档转换', '文档', 'pdf', 'word', 'docx', 'excel', 'xlsx', 'csv', '表格', 'markdown', 'md', 'html', 'txt', 'rtf', 'epub', '电子书', '转pdf', 'pdf转图片', 'pdf合并', 'pdf拆分', 'pdf旋转', 'pdf提取', 'word转html', 'word转pdf', 'md转word', 'html转word', 'txt转word', 'txt转pdf', 'excel转csv', 'excel转json', 'csv转json', 'json转csv', 'csv转excel', 'md转html', 'html转md', 'md转pdf', 'html转pdf', 'rtf转文本', 'rtf转html', 'epub转文本', 'epub转html', 'document', 'document conversion'],
    path: '/tools/document/',
    available: true,
  },
  {
